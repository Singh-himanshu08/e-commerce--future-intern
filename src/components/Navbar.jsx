...
const Navbar = () => {
  ...
  const {setShowSearch,getCartCount,getCartAmount} = useContext(ShopContext);
  return (
   <div className="flex items-center justify-between py-2 font-medium">

  <Link to='/'><img src={assets.LOGOSITE2} className='w-36 h-15' alt="Profile Icon" /></Link>
